...
def main():
    ...
    parser.add_argument("--visualize", action="store_true", help="Generate charts from latest snapshot")
    ...
    if args.all:
        ...
        plot_server_health()
        plot_retention()
        plot_guild_card(hours=args.hours)
        plot_active_player_distribution(hours=args.hours)
    elif args.fetch:
        run_fetch()
    elif args.analyze:
        run_analyze()
